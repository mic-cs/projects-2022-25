...
$email=$_REQUEST['email'];
    ...
    if ($email && filter_var($email, FILTER_VALIDATE_EMAIL)) {
        ...
        if ($result->num_rows > 0) {
            ...
            $resetLink = "http://campus.sicsglobal.co.in/Project/rain_water/api/update_password_user.php?token=$token";
            ...
            try {
                ...
                $mail->setFrom('eventcalendar980@gmail.com', 'Rain Water Harvesting App');
                ...
                $mail->Body = "
                    ...
                    Best regards,<br>
                    Rain Water Harvesting App Team
                ";
